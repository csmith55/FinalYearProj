...
import app.com.project.csmith.finalyearproject.Places.Reviews;
...
public class FetchDetails extends AsyncTask<Places, Void, Places> {
    ...
    /**
     * Creates a url connection to the Place Details API
     * Parses the JSON result
     * @param params place to get locations around
     * @return place
     */
    @Override
    ...
    /**
     * Parses the json result and stores the values into corresponding variables
     * These variables are then used to create a Place object
     * @param jsonDetailsString the string to be parsed
     * @return Place
     *
     */
