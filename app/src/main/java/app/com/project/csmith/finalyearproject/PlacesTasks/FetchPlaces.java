package app.com.project.csmith.finalyearproject.PlacesTasks;
...
public class FetchPlaces extends AsyncTask<GoogleMap, Void, Places[]> {
    ...
    /**
     * Creates a list of each category and what they can contain
     */
    ...
    /**
     * Uses the JSON result to extract the "Results" array and passes to location Data
     * @param placesJson JSON result string
    ...
    /**
     * Parses the JSON result and creates a new place in the array
     * @param GEOMETRY location information
     * @param NAME name of the place
     * @param TYPES type of establishment
     * @param placesArray json object array
     * @param pArray array to be added to
     *
     */
    ...
    /**
     * Connects to Places API to retrieve nearby locations via Utilities
     * Parses the JSON to retrieve the places
     * @param params googleMap to be displayed
     * @return Array of places
     */
    ...
    /**
     * Categorises the type of place
     * Overrides the marker click of google map to display the location information
    ...
    /**
     * Sets the current place the user has selected
    ...
    /**
     * Checks the type of the place and adds it to the correct map marker
     * @param place place to be categorised
     */
